...
ARG NEXT_PUBLIC_LEGAL_PAGES_ENABLED=false
...
ENV NEXT_PUBLIC_LEGAL_PAGES_ENABLED=$NEXT_PUBLIC_LEGAL_PAGES_ENABLED
...
RUN test "$NEXT_PUBLIC_AUTH_MODE" = supabase && \
    ...
    { test "$NEXT_PUBLIC_LEGAL_PAGES_ENABLED" = true || test "$NEXT_PUBLIC_LEGAL_PAGES_ENABLED" = false; } && \
