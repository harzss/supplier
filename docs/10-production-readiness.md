...
| 依赖与 SAST            | 🔄 CI 待验收 | `dd648f1` 生产依赖审计为 0 已知漏洞且 Release gates #32 全绿；当前分支已纳入 `security-scans.yml` 的 push 触发，M86 SHA 待推送后验收 dependency audit 与 CodeQL                                         |
